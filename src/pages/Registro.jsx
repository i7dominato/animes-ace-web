...
export default function Registro() {
  ...
  useSEO({ titulo: 'Cadastrar', descricao: 'Crie sua conta grátis no Animes Ace.' });
      ...
      <div style={s.box}>
        ...
        <form onSubmit={handleSubmit} style={s.form}>
          <div style={s.campo}>
            ...
            <input style={s.input} type="text" placeholder="Seu nome" value={nome} onChange={e => setNome(e.target.value)} />
          </div>
          ...
          <div style={s.campo}>
            ...
            <input style={s.input} type="password" placeholder="Mínimo 6 caracteres" value={senha} onChange={e => setSenha(e.target.value)} />
          </div>

          <div style={s.campo}>
            <label style={s.label}>Confirmar senha</label>
            <input style={s.input} type="password" placeholder="Repita a senha" value={confirma} onChange={e => setConfirma(e.target.value)} />
          </div>

          <button type="submit" style={{ ...s.btnPrimario, opacity: loading ? 0.6 : 1 }} disabled={loading}>
